...
-->
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="<?php echo U('Index/setspot');?>">设置</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">商店</strong>

                                <strong class="card-title">链接：<a href="<?php echo ($pic2['url']); ?>"><?php echo ($pic2['url']); ?></a></strong>
