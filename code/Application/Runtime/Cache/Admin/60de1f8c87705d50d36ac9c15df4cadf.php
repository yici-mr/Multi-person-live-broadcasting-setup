    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo U('table');?>"><img src="../../../../Public/Commth/Index/images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="<?php echo U('table');?>"><img src="../../../../Public/Commth/Index/images/logo2.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo U('table');?>"> <i class="menu-icon fa fa-导航"></i>导航 </a>
                    </li>
                    <h3 class="menu-title">商户</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>统计</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo U('table');?>">商户统计</a></li>
                        </ul>
                    </li>
