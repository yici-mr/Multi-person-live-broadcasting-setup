$(function(){
    ...
    $('.pay1').click(function(){
        $('.pay_list1').show();
        $('.pay_list2').hide();
        $(this).children('img').attr('src','/static/link/fk/images/pay1.png');
        $('.pay2').children('img').attr('src','/static/link/fk/images/pay3_menu2.png');
    });
    $('.pay2').click(function(){
        $('.pay_list2').show();
        $('.pay_list1').hide();
        $(this).children('img').attr('src','/static/link/fk/images/pay2.png');
    ...
    $('.pay_cj_1').click(function(){
        ...
        $(this).children('img').attr('src','/static/link/fk/images/pay1.png');
        $('.pay_cj_2').children('img').attr('src','/static/link/fk/images/pay3_menu2_cj.png');
    });
    $('.pay_cj_2').click(function(){
        ...
        $(this).children('img').attr('src','/static/link/fk/images/pay2.png');
        $('.pay_cj_1').children('img').attr('src','/static/link/fk/images/pay3_menu1_cj.png');
    });
});